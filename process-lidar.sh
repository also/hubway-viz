...
echo reprojecting
gdalwarp -t_srs EPSG:3857 -r bilinear data/lidar.tif data/lidar-3785.tif
...
echo generating png
gdal_translate -b 1 -of PNG -outsize 1603 1210 -scale 0 100 data/lidar-3785.tif output/lidar.png

gdal_translate -of PNG -outsize 1603 1210 data/lidar-colored-3785.tif output/lidar-colored.png
